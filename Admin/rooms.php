...
<head>
  ...
  <body class ="bg-light">
    ...
    <!--Room Modal -->
  <div class="modal fade" id="add-room" data-bs-keyboard="true" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <!-- pass the id -->
...
<div class="modal fade" id="room-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="border-bottom border-3 pb-3 mb-3">
                            <form id="add_image_form">
                                ...
                                <input type="file" name="image" accept=".jpeg , .png ,.webp , .jpeg" class="form-control shadow-none" required />
                                <button  class="btn btn-success text-white shadow-none mt-3">ADD</button>
    ...
    <div class="modal fade" id="edit-room" data-bs-keyboard="true" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <!-- pass the id -->
            <div class="modal-dialog modal-lg">
