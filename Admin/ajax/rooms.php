<?php
    ...
    if(isset($_POST['add_room'])){
        ...
        $flag = 0; //status database 

        $q = "INSERT INTO `rooms`(`name`, `area`, `price`, `quantity`, `adult`, `children`, `description`) VALUES (?,?,?,?,?,?,?)";
        $values = [$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['desc']]; //input name values 
    ...
    if(isset($_POST['edit_room'])){
        ...
        $frm_data['adult'],$frm_data['children'],$frm_data['desc'],$frm_data['room_id']]; //input name values 
    ...
    if(isset($_POST['get_room_images']))
    {
        ...
        {
            if($row['thumb']==1){
                $thumb_btn = "<i class='bi bi-check-lg text-light bg-success px-2 py-2 rounded fs-5'></i>"; 
            }
            else
            {
