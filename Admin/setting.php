        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
          ...
          <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
              <div
                class="d-flex align-items-center justify-content-between mb-3">
                <h5 class="card-title m-0">Shutdawn Website</h5>
                <div class="form-check form-switch">
                  <form action="">
                    <input
                      onchange="upd_shutdawn(this.value)"
          ...
          <div
            ...
            <div class="modal-dialog modal-lg">
              <form id="contact_s_form">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5">Contact Setting</h1>
                    <button
                      type="button"
                      class="btn-close"
                      data-bs-dismiss="modal"
              ...
              <form id="team_s_form">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button
                      type="button"
                      onclick="member_name.value='',member_picture='' "
                      class="btn text-secondary shadow-none"
                      data-bs-dismiss="modal">
                      Cansel
                    </button>
